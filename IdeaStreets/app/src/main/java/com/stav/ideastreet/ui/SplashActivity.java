...
import com.stav.ideastreet.utils.StreamUtil;
...
import static com.stav.ideastreet.utils.ActivityUtil.showToast;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case ENTER_HOME:
                    ...
                    break;
                case URL_ERROR:
                    showToast(SplashActivity.this, "URL异常");
                    enterHome();
                    break;
                case IO_ERROR:
                    showToast(SplashActivity.this, "读取异常");
                    enterHome();
                    break;
                case JSON_ERROR:
                    showToast(SplashActivity.this, "JSON解析异常");
                    enterHome();
                    break;
                default:
                    break;
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initShortCut() {
        ...
        //名称
        intent.putExtra(Intent.EXTRA_SHORTCUT_NAME, "玩转创意街");
    ...
    private void initData() {
        ...
        //检测版本号
        if (PrefUtils.getBoolean(this, ConstantValue.OPEN_UPDATE, false)) {
            checkVersion();
        } else {
            //直接进入应用程序主界面
            //消息机制
